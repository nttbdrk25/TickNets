...
```
Note: Download the trained model of TickNet-large on Datasets: [For Stanford Dogs](https://pages.github.com/); [For ImageNet-1k](https://pages.github.com/); [For Places365](https://pages.github.com/). And then locate the download file at ./checkpoints/[name_dataset]/large
