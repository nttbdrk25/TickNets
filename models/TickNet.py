...
def build_TickNet(num_classes, typesize='large', cifar=False):
    ...
    if typesize=='basic':
        channels = [[128],[64],[128],[256],[512]]#Tick-basic
    if typesize=='small':
        channels = [[128],[64,128,256,512],[128],[64,128,256],[512]]#Tick-small
    if typesize=='large':
        channels = [[128],[64,128,256,512],[128,64,128,256,512],[128,64,128,256],[512]]#Tick-large
