...
def main():
    ...
    if args.pretrained:
        ...
        model = build_TickNet(1000, typesize=args.arch, cifar=False)            
    if args.gpu is not None:
    ...
    if args.evaluate:
        #pathcheckpoint = "./runs/%s/"%(args.arch + '_' + args.action) + "model_best.pth.tar"
        pathcheckpoint = "./checkpoints/ImageNet1k/large/model_best.pth.tar"
